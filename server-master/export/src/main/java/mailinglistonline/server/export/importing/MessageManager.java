...
public class MessageManager {
    ...
    public MessageManager(DbClient dbClient, boolean sendMessagesToSearchisko, SearchClient searchManager) throws IOException {
    	this(dbClient);
            		...
            		for(int i = 0; i < 3; i++) {
            			if(saveMessage(message, i)) {
            				...
            				if(i != 3) {
            					...
            					logger.info("This message wasnt save to searchisko id: " + message.getId());            					
            				}
            			}
            		}
            	}
